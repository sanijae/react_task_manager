      ...
      <MainLayout>
        {!isLoggedIn ? (
          <div className='bg-primary text-white h-[40vh] py-8 text-center'>
            <h1 className='text-2xl'> Task Task Manager Using Mern stack</h1>
            <Link to="/signup" className='mt-10 text-xl block space-x-2 hover:space-x-4'>
              <span className='transition-[margin]'>Join now to manage your tasks on the cloud</span>
              <span className='relative ml-4 text-base transition-[margin]'><i className="fa-solid fa-arrow-right"></i></span>
            </Link>
            <h2>================================</h2>
            <h4 className='transition-[margin]'>Your tasks store on the database enable access everywhere anytime from any connected device</h4>
          </div>
        ) : (
          <>
